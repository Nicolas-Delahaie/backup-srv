...
- **Everything in English.** Code, docs, comments. This project is intended to be published. **Exception:** files under `todo/` are written in French — they are the user's personal notes. **Commit messages are in French.**
